                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="pull-right">
                            <div class="btn-group">
                                <a href="{{ route('tipoidentificacion.create') }}" class="btn btn-info">Añadir Tipo de
                                    Identificación</a>
                            </div>
                        </div>
                                        ...
                                        @foreach ($tipoIdentificaciones as $tipoIdentificacion)
                                            <tr>
                                                ...
                                                <td><a class="btn btn-primary btn-xs"
                                                        href="{{ route('tipoidentificacion.edit', $tipoIdentificacion->id_tipo_identificacion) }}"><span
                                                            class="glyphicon glyphicon-pencil"></span></a></td>
                                                <td>
                                                    <form
                                                        action="{{ route('tipoidentificacion.destroy', $tipoIdentificacion->id_tipo_identificacion) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
