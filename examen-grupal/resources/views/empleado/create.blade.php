                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="cedula_empleado" id="cedula_empleado"
                                                class="form-control input-sm" placeholder="Cédula del empleado">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="telefono_empleado" id="telefono_empleado"
                                                class="form-control input-sm" placeholder="Teléfono del empleado">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="nombre_empleado" id="nombre_empleado"
                                        class="form-control input-sm" placeholder="Nombre del empleado">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="apellidos_empleado" id="apellidos_empleado"
                                        class="form-control input-sm" placeholder="Apellidos del empleado">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="direccion_empleado" id="direccion_empleado"
                                        class="form-control input-sm" placeholder="Dirección del empleado">
                                </div>
                                <div class="row">
